  ...
  window.Cubecraft = {
    ...
    initEvents: function() {
      ...
      mousemove = function(e) {
        _this.mouse_movement.x = e.movementX || e.mozMovementX || e.webkitMovementX || 0;
        return _this.mouse_movement.y = e.movementY || e.mozMovementY || e.webkitMovementY || 0;
      };
      ...
      $(this.canvas).mousedown(function(e) {
        ...
        } else if (_this.canvas.mozRequestPointerLock) {
